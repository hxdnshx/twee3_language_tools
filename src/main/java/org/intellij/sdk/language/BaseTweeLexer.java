...
public abstract class BaseTweeLexer extends DelegateLexer implements RestartableLexer {
    ...
    protected BaseTweeLexer(@NotNull Lexer _baseLexer, boolean _caseInsensitive) {
        super(_baseLexer);
        caseInsensitive = _caseInsensitive;
        List<HtmlEmbeddedContentSupport> supports = getEmbeddedContentSupportList();
        myEmbeddedContentProviders = new ArrayList<>();
        /*
